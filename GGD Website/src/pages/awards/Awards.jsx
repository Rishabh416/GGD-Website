...
export default function Awards() {
    return(
        <div id="Awards">
            ...
            <Award img="7" title={<a href="https://hundred.org/en/articles/these-youth-led-social-impact-projects-will-inspire-you">Featured by HundrED, a global mission-driven organization transforming education through innovation, for Inspirational Youth-led Social Impact Projects</a>}/>
